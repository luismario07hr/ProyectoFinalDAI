...
from database import (
    ...
    obtener_cuadros, obtener_cuadro_por_id, insertar_cuadro, actualizar_estado_cuadro,
    obtener_detalles_por_cuadro, insertar_detalle_cuadro
)
...
def actualizar_estado(id_cuadro):
    ...
    # Se espera recibir un JSON con la llave "estado", por ejemplo: {"estado": "CERRADO"}
